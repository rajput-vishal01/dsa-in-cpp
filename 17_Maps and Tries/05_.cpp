...
A trie (pronounced "try") is a multiway tree data structure used primarily for efficient retrieval of keys, typically strings.
Each node in a trie represents a common prefix shared by some keys, allowing operations like search, insert, and prefix matching to be performed quickly. 
This structure is especially useful in applications like autocomplete and spell-checking.
*/
#include<iostream>
